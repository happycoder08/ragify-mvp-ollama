...
# 1. CONFLICTING POLICIES (Tests temporal reasoning/conflict resolution)
# We create an "Old" 2023 policy and a "New" 2025 policy.
policy_text = """
...
# 2. TECHNICAL MANUAL (Tests "Checklist" extraction and specific technical retrieval)
tech_manual = """
...
# 3. NOISE / DISTRACTOR (Tests if the AI can ignore irrelevant matches)
meeting_notes = """
Lunch Order - Friday
- Sarah: Salad
